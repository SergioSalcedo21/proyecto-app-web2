...
class Producto(models.Model):
    ...
    # Aquí vamos a crear la relación del nombre con el precio.La relación del Foreing key


    precio = models.DecimalField(max_digits=6, decimal_places=2, validators=[validar_precio_positivo])
